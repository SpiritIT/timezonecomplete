    ...
    switch (token.symbol) {
        ...
        case "z":
            switch (token.length) {
                ...
                case 2:
                case 3:
                    return zone.abbreviationForUtc(currentZone.year, currentZone.month, currentZone.day, currentZone.hour, currentZone.minute, currentZone.second, currentZone.milli, true);
                case 4:
                    return zone.toString();
            }
        case "v":
            if (token.length === 1) {
                return zone.abbreviationForUtc(currentZone.year, currentZone.month, currentZone.day, currentZone.hour, currentZone.minute, currentZone.second, currentZone.milli, false);
            } else {
                return zone.toString();
            }
        case "V":
