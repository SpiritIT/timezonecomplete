...
var TzDatabase = (function () {
    ...
    * @param zoneName	(optional) if given, the result for the given zone is returned
    */
    TzDatabase.prototype.minStandardOffset = function (zoneName) {
        if (zoneName) {
            var zoneInfos = this.getZoneInfos(zoneName);
            var result = null;
            zoneInfos.forEach(function (zoneInfo) {
    ...
    * @param zoneName	(optional) if given, the result for the given zone is returned
    */
    TzDatabase.prototype.maxStandardOffset = function (zoneName) {
        if (zoneName) {
            var zoneInfos = this.getZoneInfos(zoneName);
            var result = null;
            zoneInfos.forEach(function (zoneInfo) {
    ...
    */
    TzDatabase.prototype.localTimeExists = function (zoneName, tm) {
